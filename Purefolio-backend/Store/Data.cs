...
/// Social
        ...
        {
            new EuroStatTable(){tableCode = "env_ac_ainah_r2", attributeName = "emissionPerYear", dataType="NaceRegionData", filters="unit=KG_HAB&airpol=GHG", unit="kg per capita", datasetName="Emmisions of Greenhouse gases", esgFactor="Environment", description="Air Emissions Accounts record the flows of residual gaseous and particulate materials emitted by resident units and flowing into the atmosphere. Residual gaseous and particulate materials are the physical flows of gaseous or particulate materials (‘air emissions’).", href="https://ec.europa.eu/eurostat/cache/metadata/en/env_ac_ainah_r2_esms.htm"},
            ...
            new EuroStatTable(){tableCode = "earn_gr_gpgr2", attributeName = "genderPayGap", dataType="NaceRegionData", filters="unit=PC", unit="Percentage", datasetName="Gender pay gap", esgFactor="Corporate Governance", description="The unadjusted gender pay gap (GPG) represents the difference between average gross hourly earnings of male paid employees and of female paid employees as a percentage of average gross hourly earnings of male paid employees.", href="https://ec.europa.eu/eurostat/cache/metadata/en/earn_grgpg2_esms.htm"},
